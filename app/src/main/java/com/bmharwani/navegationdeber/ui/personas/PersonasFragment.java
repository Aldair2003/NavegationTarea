...
import com.bmharwani.navegationdeber.databinding.FragmentPersonasBinding;
...
public class PersonasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       PersonasViewModel printViewModel =
                new ViewModelProvider(this).get(PersonasViewModel.class);

        binding = FragmentPersonasBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textPersonas;
